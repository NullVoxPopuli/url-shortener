...
export const SCHEMAS = [
  ...
  withDefaults({
    ...
    fields: [
      ...
      { kind: 'field', name: 'stripeProductId' },
      { kind: 'object', name: 'prices' },
      { kind: 'field', name: 'monthlyLinkLimit' },
      { kind: 'field', name: 'teammates' },
      { kind: 'field', name: 'customDomains' },
      { kind: 'field', name: 'additionalAccounts' },
      { kind: 'field', name: 'apiKeys' },
      { kind: 'field', name: 'linkEditsPerMonth' },
      { kind: 'field', name: 'linkExpiration' },
    ],
  }),
  withDefaults({
    type: 'link',
