...
export default class Account extends BaseModel {
  ...
  @column({ columnName: 'stripe_downgraded_from_price_id' })
  declare stripeDowngradedFromPriceId: string | null;

  @column({
    columnName: 'stripe_downgraded_until',
    consume: (value) => (value === null || value === undefined ? null : Number(value)),
  })
  declare stripeDowngradedUntil: number | null;
